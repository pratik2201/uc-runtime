...
import { StyleClassScopeType } from "./global/runtimeOpt.js";
...
export declare const patternList: {
    ...
    MULTILINE_COMMENT_REGS: RegExp;
    SINGLELINE_COMMENT_REGS: RegExp;
    SPACE_REMOVER_REGS: RegExp;
    subUcFatcher: RegExp;
...
export declare class StylerRegs {
    static ScssExtractor(csscontent: string): import("./lib/OpenCloseHandler.js").OCIterator[];
...
export declare class ThemeCssHandler {
    main: StylerRegs;
    constructor(main: StylerRegs);
